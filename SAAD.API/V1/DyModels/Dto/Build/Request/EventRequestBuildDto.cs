...
{
    public class EventRequestBuildDto : ITBuildDto
    {
        /// <summary>
        /// EventId property for DTO.
        /// </summary>
        public String? EventId { get; set; } = $"Event_{Guid.NewGuid().ToString()}";
        /// <summary>
        ...
        public UserRequestBuildDto? TriggeredByUser { get; set; }
